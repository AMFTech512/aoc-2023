...
fn get_minimum_cubes(sets: &Vec<(u32, u32, u32)>) -> (u32, u32, u32) {
    ...
    let answer = lines.fold(0, |acc, line| {
        ...
        match line {
            Ok(game) => {
                ...
                // get the minimum number of cubes we need to have in the bag for the game to be possible
                let bag = get_minimum_cubes(&sets);

                // find the power of the bag
